...
public class App {
    public static void main(String[] args) throws BadInputException {
        ...
        // 필요한 계산을 입력받아 select 변수에 저장하여 입력된 계산을 반복 수행
        ...
        do {    // 1번의 계산이 끝난 후 exit 입력여부로 반복계산 실행
            ...
            if (select.equals("사칙연산")) {
                ...
                if(sc.next().equals("modify")) {
                    ...
                    calc.setResultArr(index, value);    // Calculator 사칙연산에 대한 setter 메서드 활용
                ...
                if (sc.next().equals("remove")) {
                    calc.removeResult();    // Calculator 객체의 removeResult 메서드를 통해 간접 접근해서 삭제로 수정
